    ...
    >
        <div class="modal-shell animate-modal">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="upload-tile">
                        <div class="flex items-center gap-2 mb-3">
                            ...
                            <span class="font-dosis text-sm font-semibold text-abyss-800 dark:text-platinum-100">
                                Module Document
                            </span>
                        </div>

                        <div v-if="props.module.file_name"
                        ...
                        >
                            <span class="font-mplusrounded text-sm font-normal truncate
                                         text-platinum-600 dark:text-platinum-400">
                                {{ props.module.file_name }}
                            </span>
                            <button v-if="newFile" @click="clearFile" type="button"
                                class="shrink-0 font-dosis text-xs font-semibold text-red-500 hover:text-red-600 transition-colors">
                                Remove
                            </button>
                        </div>
                    ...
                    <div class="upload-tile">
                        ...
                        <div v-if="props.module.thumbnail_url && !newThumbnail" class="flex items-center gap-3 mb-3">
                            <img
                                :src="props.module.thumbnail_url"
                                class="w-14 h-10 object-cover rounded-lg shrink-0
                                       border-2 border-platinum-300 dark:border-abyss-500"
                            />
                            <span class="font-mplusrounded text-sm font-normal text-platinum-500 dark:text-platinum-400">
                                Current thumbnail
                            </span>
                        </div>
                        ...
                        <button v-if="newThumbnail" @click="clearThumbnail" type="button"
                            class="mt-2 font-dosis text-xs font-semibold text-red-500 hover:text-red-600 transition-colors">
                ...
                <div class="toggle-row">
                    <label class="toggle-item group">
                        ...
                        <div :class="[
                            ...
                            <div :class="['toggle-thumb', form.is_published ? 'translate-x-4' : 'translate-x-0']"></div>
                        </div>
                        <div>
                    ...
                    <label class="toggle-item group">
                        ...
                        <div :class="[
                            ...
                            <div :class="['toggle-thumb', form.is_featured ? 'translate-x-4' : 'translate-x-0']"></div>
                        </div>
                        <div>
                            <p class="font-dosis text-sm font-semibold text-abyss-800 dark:text-platinum-100
                                       group-hover:text-calm-lavender-600 dark:group-hover:text-calm-lavender-400 transition-colors">
            ...
            <footer class="modal-footer">
                ...
                >
                    <span v-if="!saving" class="font-dosis font-semibold text-sm uppercase tracking-wider">
                        Save Changes
                    </span>
