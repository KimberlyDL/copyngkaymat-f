<template>
    <div class="p-8 space-y-8 font-['Poppins'] text-white">
        <div class="flex justify-between items-center">
            ...
            <button @click="openCreateModal" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-pink-600 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-lg hover:scale-105 transition-all">
                Add New Item
            </button>
        </div>
                ...
                <div class="relative z-10 space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 bg-black/40 rounded-2xl border border-white/5">
                        <div class="flex flex-col">
                            ...
                            <span :class="['text-sm font-black', reward.stock_quantity < 5 ? 'text-red-500' : 'text-emerald-400']">
                                {{ reward.stock_quantity }} PCS LEFT
                            </span>
                        </div>
                        <button @click="editStock(reward)" class="p-2 bg-white/5 rounded-xl hover:bg-blue-500/10 hover:text-blue-400 transition-all">
